...
const Hotel = (props) => {
  ...
  return (
    ...
    <div className={`relative  rounded-xl w-full pb-20 px-3 h-[59vh] ${currentLanguage=="ar"?"rtl":"ltr"}`}>
        <img  loading="lazy" onClick={()=>{navigate("/hotel",{state:{hotel:{...props.hotel}}})}} src={props.hotel.image} alt="hotel-image" className='w-full h-1/3 xl:h-1/2 rounded-xl cursor-pointer '/>
